...
function show_create_form_bingo(game_id)
{
	$("#game_id_hidden_bingo").val(game_id);
	
	$("#input_bingo_text").focus();
...
function close_dialog_bingo()
{
	$("#dialog_bingo").dialog("destroy");
}
...
?>
<form action="engine/save_check_bingo.php" method="POST">
	<h3>V&eacute;rifier Bingo!</h3>
	<input id="input_no" type="text" name="number">
	<input type="hidden" name="game_id" value="<?php echo $game_id ?>">
	<input class="info" type="submit" value="Verifier" <?php  if (($is_bingo == "true") || ($is_deleted == "true")){echo 'disabled="disabled"';} ?>>
</form>

<br>
<br>
<input class="success large" type="button" value="Valider Bingo!" <?php echo 'onclick="show_create_form_bingo('.$game_id.')"'; if (($is_bingo == "true") || ($is_deleted == "true")){echo 'disabled="disabled"';} ?>>
...
if ($row)
{
	...
	$result_no = mysqli_query($con, "SELECT * FROM number where game_id = ".$game_id." and is_active=0 and check_state=2") or die(mysqli_error($con)); 
...
<form action="engine/delete_check_bingo.php" method="post">
...
<!-- Validate bingo form -->
<div id="dialog_bingo" title="Supprimer?"   style="display:none">
<form action="engine/validate_bingo.php" method="post">
<table width="100%" class="bordered">
<tr><td>Saissisez "bingo" et cliquez sur valider pour valider ce gain (bingo)</td></tr>
<tr><td>
<input id="input_bingo_text" type="text" name="confirm">
<input type="hidden" name="game_id" id="game_id_hidden_bingo">
</td></tr>
<tr><td><input class="success" type="submit" value="Valider"><input class="danger" type="button" value="Annuler" onclick="close_dialog_bingo()" style="margin-left:10px"></td></tr>
</table>
</form>
<br>
</center>
...
<form action="engine/quit_check_bingo.php" method="post">
<table width="100%" class="bordered">
